                                            ...
                                            <tr id="entity-row-{{ $subscriber->id }}">
                                                ...
                                                <td>
                                                    ...
                                                    @if($subscriber->username)
                                                        ...
                                                        <a href="https://t.me/{{ $subscriber->username }}"
                                                           target="_blank">
                                                            @ {{ $subscriber->username }}
                                                        </a>
                                                ...
                                                <td class="text-nowrap">
                                                    ...
                                                    @else
                                                        ...
                                                        @elseif(auth()->user()?->isViewer())
                                                            ...
                                                            <span title="Керування блокуванням доступне лише адміністратору">

                                                                <button type="button"
                                                                        class="btn {{ $subscriber->is_banned ? 'btn-success' : 'btn-warning' }} btn-sm float-start me-1 opacity-50 cursor-not-allowed"
                                                                        disabled>
