...
@include('layouts.inc.seo', [
    'title' => 'Фільми з субтитрами ' . $caption->title,
    'description' => 'Фільми з субтитрами «' . $caption->title . '».',
])
...
@section('content')
    ...
    <div class="container-arch flex-arch">
        @include('layouts.inc.breadcrumbs', ['breadcrumbs' => [
            ...
            ['title' => 'Cубтитри', 'url' => route('captions.index')],
