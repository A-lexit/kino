...
@include('layouts.inc.seo', [
    'title' => 'Вікове обмеження ' . $age->title,
    'description' => 'Фільми з віковим рейтингом ' . $age->title . '.',
])
...
@section('content')
    ...
    <div class="container-arch flex-arch">
        @include('layouts.inc.breadcrumbs', ['breadcrumbs' => [
            ...
            ['title' => 'Мінімальний вік', 'url' => route('ages.index')],
            ...
            <div class="container-archive">
                @foreach($films as $film)
                    <div class="child-archive">
                        <div>
                            {{--<img src="{{ $film->thumb_url }}" alt="{{ $film->title }}" width="155" height="235" decoding="async">--}}
