...
- Асинхронне виконання задач через Redis Queues (завантаження зображень під час імпорту фільмів через TMDb, Telegram-повідомлення, коментарі, email-розсилка)
...
## Запуск черг (Queue Worker)

Для асинхронної обробки фонових задач (завантаження постерів, Telegram-сповіщення, додавання коментарів, відправка листів) необхідно запустити воркер черг:
